...
class TodoItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todo_item" do
    assert_difference('TodoItem.count') do
      post todo_items_url, params: { todo_item: { completed: @todo_item.completed, description: @todo_item.description, timestamps: @todo_item.timestamps, todo_list_id: @todo_item.todo_list_id } }
    end
  ...
  test "should update todo_item" do
    patch todo_item_url(@todo_item), params: { todo_item: { completed: @todo_item.completed, description: @todo_item.description, timestamps: @todo_item.timestamps, todo_list_id: @todo_item.todo_list_id } }
